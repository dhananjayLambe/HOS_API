...
import { DOBInput } from "@/components/date-input"
...
interface FormData {
  ...
  clinic_id: string // Moved clinic_id to root level
...
const steps = [
  ...
  { id: 5, title: "Review & Submit", icon: CheckCircleIcon, description: "Review your information before submitting" },
]
...
export function DoctorOnboarding() {
  ...
  const [openMedicalCouncil, setOpenMedicalCouncil] = useState(false)
        ...
        if (Array.isArray(obj[key])) {
          ...
          if (prefix === "user.") {
            ...
            if (key === "medical_registration_number") {
              ...
              // Map clinic_id error
              flatErrors["clinic_id"] = obj[key].join(" ")
            } else {
              flatErrors[key] = obj[key].join(" ")
            }
          } else {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        digital_signature_consent: formData.digital_signature_consent,
        government_ids: formData.government_ids,
        registration: formData.registration,
        clinic_id: formData.clinic_id, // clinic_id at root level
        terms_conditions_accepted: formData.terms_conditions_accepted,
      ...
      if (response.ok && result.status === "success") {
        ...
        if (result.errors) {
          ...
          setErrorDialogMessage("Validation errors occurred. Please check the form and try again.")
          ...
          setErrorDialogMessage("Registration failed. Please try again.")
          setErrorDialogDetails([])
          setShowErrorDialog(true)
      ...
      setErrorDialogMessage("Network error occurred")
      setErrorDialogDetails([
  ...
  const getClinicName = (clinicId: string) => {
    ...
    return clinic ? clinic.name : "Not selected"
  }

  const getMedicalCouncilName = (councilValue: string) => {
    const council = medicalCouncils.find((c) => c.value === councilValue)
    return council ? council.label : councilValue
  }
              ...
              <div className="text-center space-y-4 sm:space-y-8">
                ...
                <div className="space-y-2 sm:space-y-4">
                  ...
                  <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto text-balance px-4">
                    Welcome to our EMR platform, Your journey to digital healthcare begins now. Admin will verify your
                    documents within 24-48 hours.will notify you via email once the verification is complete.
  ...
  return (
    <div className="min-h-screen gradient-bg relative overflow-hidden">
      <AlertDialog open={showErrorDialog} onOpenChange={setShowErrorDialog}>
        <AlertDialogContent className="max-w-lg border-destructive/20 bg-gradient-to-br from-background via-background to-destructive/5">
          <AlertDialogHeader>
            <div className="flex items-start justify-between gap-4 mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Please review the errors below</p>
                </div>
              </div>
              <button
          ...
          {errorDialogDetails.length > 0 && (
            <div className="my-4 p-5 bg-gradient-to-br from-destructive/10 to-destructive/5 rounded-xl border border-destructive/20 shadow-sm">
              ...
              <ul className="space-y-2">
                {errorDialogDetails.map((detail, index) => (
                  <li key={index} className="flex items-start gap-3 text-sm">
                    <span className="w-1.5 h-1.5 rounded-full bg-destructive/60 mt-2 flex-shrink-0"></span>
          ...
          <div className="bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20 p-4 rounded-xl border border-border/50">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Close this dialog to review and correct the highlighted fields in the form, then try submitting again.
                </p>
              </div>
            </div>
          </div>
          ...
          <AlertDialogFooter className="mt-6">
            <AlertDialogAction
              onClick={() => setShowErrorDialog(false)}
              className="w-full  bg-purple-600 from-destructive to-destructive/90 hover:from-destructive/90 hover:to-destructive/80 text-black shadow-lg hover:shadow-xl transition-all duration-300"
            >
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-6 relative z-10">
        ...
        <Card className="max-w-4xl mx-auto glass-card animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
            ...
            {currentStep === 3 && (
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Popover open={openMedicalCouncil} onOpenChange={setOpenMedicalCouncil}>
                      ...
                      >
                        {formData.registration.medical_council
                          ? medicalCouncils.find((council) => council.value === formData.registration.medical_council)
                              ?.label
                          : "Search and select your medical council..."}
                        <svg
                    ...
                    <PopoverContent className="w-full p-0 bg-gray-100" align="start">
                      <Command>
                        <CommandInput placeholder="Type to search medical councils..." />
                        <CommandList>
                          ...
                          <CommandGroup>
                            {medicalCouncils.map((council) => (
                              <CommandItem
                                ...
                                value={council.label}
                                onSelect={() => {
                                  updateFormData("registration", "medical_council", council.value)
                                  setOpenMedicalCouncil(false)
                              ...
                              >
                                <svg
                                  className={`mr-2 h-4 w-4 ${
                                    formData.registration.medical_council === council.value
                                      ? "opacity-100"
                                      : "opacity-0"
                                  }`}
                                  fill="currentColor"
                ...
                <div className="space-y-2">
                  ...
                  >
                    <PopoverTrigger asChild>
                      ...
                      >
                        {isClinicsLoading
                          ? "Loading clinics..."
                          : formData.clinic_id
                            ? clinics.find((clinic) => clinic.id === formData.clinic_id)?.name
                            : "Search and select your clinic (optional)..."}
                        <svg
                          className="ml-2 h-4 w-4 shrink-0 opacity-50"
                          fill="none"
                          stroke="currentColor"
                    ...
                    <PopoverContent className="w-full p-0 bg-gray-100" align="start">
                      <Command>
                        <CommandInput placeholder="Type to search clinics..." />
                        <CommandList>
                            ...
                            {clinics.length > 0 ? (
                              clinics.map((clinic) => (
                                ...
                                >
                                  <svg
                                    className={`mr-2 h-4 w-4 ${
                                      formData.clinic_id === clinic.id ? "opacity-100" : "opacity-0"
                                    }`}
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                  >
                              ...
                              <CommandItem disabled>No clinics available</CommandItem>
                            )}
                          </CommandGroup>
                        </CommandList>
                      </Command>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className="text-xs text-muted-foreground space-y-2">
                          <p>
                            I consent to use digital signatures for medical documents and prescriptions as per
            ...
            {currentStep === 5 && (
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-gradient-to-r from-medical-blue/10 to-success-green/10 p-4 sm:p-6 rounded-lg border border-medical-blue/20">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 medical-gradient rounded-lg flex items-center justify-center">
                      <CheckCircleIcon />
                    </div>
                    <h3 className="font-semibold text-foreground text-base sm:text-lg">Review Your Information</h3>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Please review all the information you've provided. You can edit any section by clicking the edit
                    button.
                  </p>
                </div>
                ...
                <div className="glass-card p-4 sm:p-6 rounded-lg border border-border/50">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button
                      ...
                      className="text-medical-blue hover:text-medical-blue-light hover:bg-medical-blue/10"
                    >
                      <EditIcon />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div className="space-y-1">
                      ...
                      <p className="font-medium">{formData.user.first_name || "-"}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Last Name</p>
                      <p className="font-medium">{formData.user.last_name || "-"}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Mobile Number</p>
                      <p className="font-medium">{formData.user.username || "-"}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Email</p>
                      <p className="font-medium break-all">{formData.user.email || "-"}</p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1 sm:col-span-2">
                      <p className="text-muted-foreground text-xs">Secondary Mobile</p>
                      <p className="font-medium">{formData.secondary_mobile_number || "Not provided"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-4 sm:p-6 rounded-lg border border-border/50">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="font-semibold text-foreground">Government IDs</h4>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Aadhar Card Number</p>
                      <p className="font-medium font-mono">{formData.government_ids.aadhar_card_number || "-"}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">PAN Card Number</p>
                      <p className="font-medium font-mono">{formData.government_ids.pan_card_number || "-"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-4 sm:p-6 rounded-lg border border-border/50">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="font-semibold text-foreground">Medical Registration</h4>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                  ...
                  <div className="grid grid-cols-1 gap-4 text-sm">
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Medical Registration Number</p>
                      <p className="font-medium font-mono">
                        {formData.registration.medical_registration_number || "-"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Medical Council</p>
                      <p className="font-medium">
                        {getMedicalCouncilName(formData.registration.medical_council) || "-"}
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-xs">Clinic</p>
                      <p className="font-medium">{getClinicName(formData.clinic_id)}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-4 sm:p-6 rounded-lg border border-border/50">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="font-semibold text-foreground">System & Compliance</h4>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center gap-2">
                      {formData.digital_signature_consent ? (
                      ...
                      <span className="text-muted-foreground">Digital Signature Consent</span>
                    </div>
                    <div className="flex items-center gap-2">
                      {formData.terms_conditions_accepted ? (
                        <Badge className="success-gradient text-white">
                          <CheckCircleIcon />
                          <span className="ml-1">Accepted</span>
                        </Badge>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-muted-foreground">Data Storage Consent (HIPAA/GDPR)</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-success-green/10 to-medical-teal/10 p-4 rounded-lg border border-success-green/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h5 className="font-semibold text-success-green text-sm mb-1">Ready to Submit</h5>
                      <p className="text-xs text-muted-foreground">
                        By clicking "Submit Registration", you confirm that all the information provided is accurate and
                        complete. Your application will be reviewed by our admin team within 24-48 hours.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="text-center mt-4 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.4s" }}>
