...
// GET - Retrieve a specific fee structure
export async function GET(
  ...
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        {
          error: data.message || data.detail || "Failed to fetch fee structure",
          ...data,
        },
        { status: response.status }
      )
...
// PUT - Update a fee structure (full update)
export async function PUT(
  ...
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        {
          error: data.message || data.detail || "Failed to update fee structure",
...
// PATCH - Partially update a fee structure
export async function PATCH(
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          error: data.message || data.detail || data.error || "Failed to update fee structure",
          errors: data.errors || data,
...
export async function DELETE(
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        {
          error: data.message || data.detail || "Failed to delete fee structure",
          ...data,
        },
        { status: response.status }
      )
