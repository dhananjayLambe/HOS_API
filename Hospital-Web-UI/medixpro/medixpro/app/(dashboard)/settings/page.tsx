    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="clinic" className="w-full">
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-5">
          ...
          <TabsTrigger value="preferences">Clinic Preferences</TabsTrigger>
        ...
        {/* Clinic Preferences Tab - Coming Soon */}
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16 px-4">
              <div className="flex flex-col items-center gap-4 text-center max-w-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-semibold">Clinic Preferences</h3>
                ...
                <p className="text-sm text-muted-foreground">
                  Configure clinic-level operational preferences including appointment behavior, language settings, 
                  patient privacy controls, and system workflow settings. This feature will be available in a future update.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16 px-4">
              <div className="flex flex-col items-center gap-4 text-center max-w-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-semibold">Branding & Appearance</h3>
                  <div className="flex items-center gap-2 justify-center text-muted-foreground">
                    <Sparkles className="h-4 w-4" />
                    <p className="text-sm">Coming Soon</p>
                  </div>
                ...
                <p className="text-sm text-muted-foreground">
                  Customize your clinic's visual identity with logos, color schemes, and branding elements. 
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16 px-4">
              <div className="flex flex-col items-center gap-4 text-center max-w-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Configure security and privacy settings including password policies, two-factor authentication, 
                  and data protection. This feature will be available in a future update.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16 px-4">
              <div className="flex flex-col items-center gap-4 text-center max-w-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced system settings including maintenance, backup & restore, and system information. 
                  This feature will be available in a future update.
                </p>
              </div>
            </CardContent>
