...
#     """
#     Clinical test recommendation by doctor.

#     This model:
#     - Represents doctor intent
#     - Is NOT booking
#     - Generates stable Test PNR
...
#         "diagnostic_core.DiagnosticServiceMaster",
#         on_delete=models.PROTECT,
...
#         constraints = [
#             models.UniqueConstraint(
#                 fields=["consultation", "service"],
#                 name="unique_service_per_consultation"
#             )
#         ]
#         indexes = [
#             models.Index(fields=["consultation"]),
...
#                 old = type(self).objects.only("consultation_id").get(pk=self.pk)
#                 if old.consultation_id != self.consultation_id:
#                     raise ValidationError("Cannot reassign to another consultation.")

#             if self.consultation.is_finalized:
#                 raise ValidationError(
#                     "Cannot add or modify tests after consultation finalized."
#                 )

#             if not self.test_pnr:
#                 self._generate_test_pnr()
...
#     def _generate_test_pnr(self):
#         encounter = self.consultation.encounter
#         count = (
#             TestRecommendation.objects
#             .filter(consultation=self.consultation)
#             .count() + 1
#         )
#         self.test_pnr = f"{encounter.visit_pnr}-DX{count}"

#     def __str__(self):
#         return f"{self.test_pnr} | {self.service.name}"

# class DiagnosticOrderLink(models.Model):
#     """
#     Bridge between clinical recommendation
#     and commercial diagnostic order.
...
#         "consultations.TestRecommendation",
#         on_delete=models.CASCADE,
#         related_name="order_link"
#     )

#     diagnostic_order = models.ForeignKey(
#         "diagnostic_core.DiagnosticOrder",
#         on_delete=models.CASCADE,
...
#     def __str__(self):
#         return f"{self.recommendation.test_pnr} → {self.diagnostic_order.order_number}"

# class TestPackageRecommendation(models.Model):
#     """
#     Clinical test package recommendation by doctor.

#     - Represents bundled diagnostic intent.
#     - No pricing or provider logic.
#     - Generates stable Package PNR.
#     - Immutable after consultation finalization.
#     """
...
#         "diagnostic_core.DiagnosticPackageMaster",
#         on_delete=models.PROTECT,
#         related_name="consultation_recommendations",
#         db_index=True
#     )
...
#         constraints = [
#             models.UniqueConstraint(
#                 fields=["consultation", "package"],
#                 name="unique_package_per_consultation"
#             )
#         ]
...
#                 if old.consultation_id != self.consultation_id:
#                     raise ValidationError(
#                         "Cannot reassign package recommendation to another consultation."
#                     )

#             # Block after finalization
#             if self.consultation.is_finalized:
#                 raise ValidationError(
#                     "Cannot add or modify package after consultation finalized."
#                 )

#             # Generate PNR
#             if not self.package_pnr:
#                 self._generate_package_pnr()
...
#     def _generate_package_pnr(self):
#         encounter = self.consultation.encounter

#         count = (
#             TestPackageRecommendation.objects
#             .filter(consultation=self.consultation)
#             .count() + 1
#         )

#         self.package_pnr = f"{encounter.visit_pnr}-PKG{count}"
...
#         if self.consultation.is_finalized:
#             raise ValidationError(
#                 "Cannot delete package recommendation after consultation finalized."
#             )
...
#     def __str__(self):
#         return f"{self.package_pnr} | {self.package.name}"

# class DiagnosticPackageOrderLink(models.Model):
#     """
#     Bridge between package recommendation
...
#     recommendation = models.OneToOneField(
#         "consultations.TestPackageRecommendation",
#         on_delete=models.CASCADE,
#         related_name="order_link"
#     )
...
#     def __str__(self):
#         return f"{self.recommendation.package_pnr} → {self.diagnostic_order.order_number}"
