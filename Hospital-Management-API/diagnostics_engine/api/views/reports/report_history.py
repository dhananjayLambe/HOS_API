"""GET operational report history (active lineage only — not audit)."""
...
from diagnostics_engine.services.reports.report_history_presenter import build_operational_report_history_dto
from diagnostics_engine.services.reports.report_query_service import ReportQueryService


class ReportHistoryView(LabReportOperationalMixin):
    ...
    def get(self, request, report_id):
        ...
        dto = build_operational_report_history_dto(report)
        payload = OperationalReportHistorySerializer.from_dto(dto).data
